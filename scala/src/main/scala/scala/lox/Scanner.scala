...
//      //> two-char-tokens
//      case '!' =>
//        addToken(if (`match`('=')) BANG_EQUAL
//        else BANG)
//
//      case '=' =>
//        addToken(if (`match`('=')) EQUAL_EQUAL
//        else EQUAL)
//
//      case '<' =>
//        addToken(if (`match`('=')) LESS_EQUAL
//        else LESS)
//
//      case '>' =>
//        addToken(if (`match`('=')) GREATER_EQUAL
//        else GREATER)
//
//      //< two-char-tokens
//      //> slash
...
//    var `type` = Scanner.keywords.get(text)
